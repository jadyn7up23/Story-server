...
from story import story_opener
...
async def start():
    ...
    msg = cl.Message(content=story_opener)
    await msg.send()
    conversation_context.append(f"Narrator: {story_opener}")
...
generated_text = "This is a test. It contains two sentences."
analysis = analyze_generated_text(generated_text)
print(analysis)
# Output: {'sentence_count': 2, 'word_count': 8, 'character_count': 43}
